...
namespace com.cobalt910.core.Runtime.Misc
{
    ...
    public class SmoothFollow : MonoBehaviour
    {
        ...
        [BoxGroup, SerializeField] Interpolator _interpolator = Interpolator.DampedSpring;
        [BoxGroup, SerializeField] Transform _target;
        
        [BoxGroup("Interpolation Speed"), Label("Position"), SerializeField, Range(0, 20)] float _positionSpeed = 2;
        [BoxGroup("Interpolation Speed"), Label("Rotation"), SerializeField, Range(0, 20)] float _rotationSpeed = 2;
        
        [BoxGroup("Random Jump"), Label("Distance"), SerializeField] float _jumpDistance = 1;
        [BoxGroup("Random Jump"), Label("Angle"), SerializeField, Range(0, 360)] float _jumpAngle = 60;
